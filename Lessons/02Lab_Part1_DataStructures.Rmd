...
temps_F <- c(55,52,30,27,33,38,40,32,32,32)
...
matrix1[4, 1] #provides specific value 104

matrix1[4,  ] #provides all values in row 4

matrix1[ , 3] #provides all values in column C

matrix1[c(12, 14)] #

matrix1[c(12:14)] #colon gives a slice 
