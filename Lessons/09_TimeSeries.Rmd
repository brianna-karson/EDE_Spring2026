...
```{r}
?stl
# Generate the decomposition #to do the decomposition (stl), you need to first define the time series object
...
#trends are generally compared pairwise, so seasonal data complicates this approach - must use Mann-Kendall 
