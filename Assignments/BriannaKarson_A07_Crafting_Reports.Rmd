...
```{r box.plot.1 , echo=FALSE, include=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.height=3.5, fig.cap="Monthly Ozone (2018)"}
#2018 plot
plot1 <- epa_data %>%
...
ggplot(aes(x = month_f, y = Ozone)) +
  geom_boxplot() +
  labs(y = expression(paste("Ozone (", mu ,"/" , m^{3}, ")")), 
       x = "", 
       title = "Monthly Ozone: 2018")
print(plot1)
```

```{r box.plot.2 , echo=FALSE, include=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.height=3.5, fig.cap="Monthly Ozone (2019)"}
#2019 plot
plot2 <- epa_data %>%
    mutate(month_f = factor(
           Month, level = 1:12, 
...
## Git Repository
https://github.com/brianna-karson/EDE_Spring2026/commit/b8f922d7413946e8ded4dea1a5e61393235d2c8b

I did not use AI in the completion of this assignment


Brianna Karson, 3/1/2026
